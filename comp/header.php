...
<head>
    ...
    <title>Outdoor Living - Furniture</title>
                                            ...
                                            <ul class="mainmenu">
                                                <li class="mainmenu__item menu-item-has-children">
                                                    <a href="index.php" class="mainmenu__link">
                                                        <span class="mm-text">Outdoor Living</span>
                                                    </a>
                                                </li>
                                                <li class="mainmenu__item menu-item-has-children megamenu-holder">
                                                    <a href="shop_full.php" class="mainmenu__link">
                                                        <span class="mm-text">Catálogo</span>
                                                    </a>
                                                </li>
                                                <li class="mainmenu__item">
                                                    <a href="#contact" class="mainmenu__link">
                                                        <span class="mm-text">Contacte Nos</span>
                                                    </a>
                                                </li>
                                            </ul>
                                        </nav>
