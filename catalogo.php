...
$categoriaSelecionada = isset($_GET['categoria']) ? $_GET['categoria'] : 0;

// Condição da query, baseada na categoria selecionada
$condicaoCategoria = $categoriaSelecionada ? "WHERE id_categoria = $categoriaSelecionada" : "";

// Obtendo o total de móveis, considerando a categoria selecionada
$queryTotalProdutos = "SELECT COUNT(*) as total FROM moveis join categorias on moveis.categoria = categorias.id_categoria $condicaoCategoria";
$resultTotal = $conn->query($queryTotalProdutos);
$totalProdutos = $resultTotal->fetch_assoc()['total'];

// Obtendo móveis para a página atual
$queryProdutos = "SELECT * FROM moveis join categorias on moveis.categoria = categorias.id_categoria $condicaoCategoria LIMIT $offset, $produtosPorPagina";
        ...
        <div class="row">
            <div class="col-12 text-center">
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="current"><span>Catálogos</span></li>
                </ul>
            </div>
        </div>
    </div>
                                ...
                                <div class="shop-toolbar__left">
                                    <div class="product-ordering">
                                        ...
                                        <form method="GET" action="">
                                            <select name="categoria" class="product-ordering__select nice-select" onchange="this.form.submit()">
                                                <option value="0">Todas Categorias</option>
                                                <?php 
                                                // Exibindo categorias com a opção selecionada
